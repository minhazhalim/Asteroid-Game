...
class Player {
     ...
     draw(){
          zim.save();
          zim.translate(this.position.x,this.position.y)
          zim.rotate(this.rotation);
          zim.translate(-this.position.x,-this.position.y);
          zim.beginPath();
          zim.arc(this.position.x,this.position.y,5,0,Math.PI * 2,false);
          zim.fillStyle = 'red';
          zim.fill();
          zim.closePath();
          zim.beginPath();
          zim.moveTo(this.position.x + 30,this.position.y);
          zim.lineTo(this.position.x - 10,this.position.y - 10);
          zim.lineTo(this.position.x - 10,this.position.y + 10);
          zim.closePath();
...
class Projectile {
     ...
     draw(){
          zim.beginPath();
          zim.arc(this.position.x,this.position.y,this.radius,0,Math.PI * 2,false);
          zim.closePath();
          zim.fillStyle = 'white';
          zim.fill();
     };
